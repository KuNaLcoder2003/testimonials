                                                    ...
                                                    <div className="w-[70%] mx-auto flex flex-col items-center gap-6 overflow-y-scroll">
                                                        {
                                                            testiMonials.map((item, idx) => {
                                                                return (
                                                                    <div key={`${item.created_at}_${idx}`} className="w-full shadow-lg p-4 flex flex-col items-baseline gap-4">
                                                                        <div className="w-full flex items-center justify-between">
                                                                            <p className="text-blue-600 bg-blue-300/50 rounded-lg w-auto px-4 py-1">{item.type}</p>
                                                                            <div className="flex items-center gap-4">
                                                                                <Star color="black" fill="white" size={15} className="cursor-pointer" />
                                                                                <Heart color="black" fill="white" className="cursor-pointer" size={15} />
                                                                            </div>
                                                                        </div>
